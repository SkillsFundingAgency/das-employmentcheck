...
namespace SFA.DAS.EmploymentCheck.Application.Tests.Commands.InitiateEmploymentCheckForChangedNationalInsuranceNumbersTests
{
    ...
    public class InitiateEmploymentCheckForChangedNationalInsuranceNumbersTests
    {
        ...
        private InitiateEmploymentCheckForChangedNationalInsuranceNumbersRequest _request;
        private SubmissionEvent _submissionEvent = new SubmissionEvent { Uln = 1234565, NiNumber = "JA123456C", Id = 124, ActualStartDate = DateTime.Now.AddYears(-1), EmployerReferenceNumber = 123456, Ukprn = 5465 };
        ...
        public void SetUp()
        {
            ...
            _request = new InitiateEmploymentCheckForChangedNationalInsuranceNumbersRequest();
        }
