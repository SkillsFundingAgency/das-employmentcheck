...
namespace SFA.DAS.EmploymentCheck.Functions.Application.Services.EmploymentCheck
{
    public interface IEmploymentCheckService
    {
        ...
        Task<IList<EmploymentCheckModel>> GetApprenticeEmploymentChecksBatch_Service(long employmentCheckLastGetId);
        ...
        Task EnqueueApprenticeEmploymentCheckMessages_Service(EmploymentCheckData apprenticeEmploymentData);
        ...
        /// </summary>
        /// <returns></returns>
        Task<EmploymentCheckMessageModel> DequeueApprenticeEmploymentCheckMessage_Service();
        ...
        Task<EmploymentCheckMessageModel> DequeueApprenticeEmploymentCheckMessage_Base(
                    ILogger logger,
                    string connectionString,
                    int batchSize,
                    string azureResource,
        ...
        Task SaveEmploymentCheckResult_Service(EmploymentCheckMessageModel apprenticeEmploymentCheckMessageModel);
