...
namespace SFA.DAS.EmploymentCheck.Functions.Application.Services.Learner
{
        ...
        : ILearnerService
    {
        ...
        #region GetNiNumbers
        public async Task<IList<LearnerNiNumber>> GetNiNumbers(IList<Models.EmploymentCheck> apprenticeshipEmploymentChecks)
        {
        ...
        {
            var thisMethodName = $"{nameof(LearnerService)}.GetNiNumbers()";
        ...
        {
            var thisMethodName = $"{nameof(LearnerService)}.GetDcToken()";
        ...
        {
            var thisMethodName = $"{nameof(LearnerService)}.StoreDataCollectionsResponse()";
        ...
        #region Stub data
        public async Task<IList<LearnerNiNumber>> GetLearnerNiNumbersStub(IList<Models.EmploymentCheck> apprenticeEmploymentChecks)
        {
        ...
        public Task<IList<LearnerNiNumber>> GetNiNumbersStub(IList<Models.EmploymentCheck> employmentCheckBatch)
        {
            throw new System.NotImplementedException();
        }

        private async Task<LearnerNiNumber> FindApprenticeNiNumberStub(Models.EmploymentCheck apprenticeEmploymentCheck)
        {
        ...
        private async Task<LearnerNiNumber> FindApprenticeNiNumber2Stub(Models.EmploymentCheck apprenticeEmploymentCheck)
        {
