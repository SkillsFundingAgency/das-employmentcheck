...
namespace SFA.DAS.EmploymentCheck.Functions.Triggers
{
    public static class ProcessEmploymentChecksHttpTrigger
    {
        ...
        public static async Task<HttpResponseMessage> HttpStart(
            ...
            ILogger log)
        {
            log.LogInformation($"Triggering {nameof(ProcessEmploymentCheckCacheRequestsOrchestrator)}");

            string instanceId = await starter.StartNewAsync(nameof(ProcessEmploymentCheckCacheRequestsOrchestrator), null);
