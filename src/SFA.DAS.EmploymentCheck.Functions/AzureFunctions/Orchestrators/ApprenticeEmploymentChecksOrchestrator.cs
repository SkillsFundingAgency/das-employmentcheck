...
namespace SFA.DAS.EmploymentCheck.Functions.AzureFunctions.Orchestrators
{
    ...
    {
        private readonly ILogger<ApprenticeEmploymentChecksOrchestrator> _logger;

        /// <summary>
        /// The ApprenticeEmploymentChecksOrchestrator orchestrator constructor, used to initialise the logging component.
        /// </summary>
        /// <param name="logger"></param>
        public ApprenticeEmploymentChecksOrchestrator(ILogger<ApprenticeEmploymentChecksOrchestrator> logger)
        {
            _logger = logger;
        }
        ...
        public async Task ApprenticeEmploymentChecksOrchestratorTask([OrchestrationTrigger] IDurableOrchestrationContext context)
        {
            var thisMethodName = $"\n\n{nameof(ApprenticeEmploymentChecksOrchestrator)}.ApprenticeEmploymentChecksOrchestratorTask()";
            ...
            try
            {
                ...
                var processApprenticeEmploymentChecksTask = context.CallSubOrchestratorAsync(nameof(ProcessApprenticeEmploymentChecksWithRateLimiterOrchestrator), 0);
