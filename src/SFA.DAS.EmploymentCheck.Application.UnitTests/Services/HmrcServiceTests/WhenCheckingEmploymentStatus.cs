...
//        private Mock<ITokenStore> _tokenServiceMock;
...
//            _tokenServiceMock = new Mock<ITokenStore>();
...
//            _tokenServiceMock.Setup(x => x.GetTokenAsync("")).ReturnsAsync(_token.AccessCode);
