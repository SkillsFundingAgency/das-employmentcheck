...
namespace SFA.DAS.EmploymentCheck.Application.UnitTests.Clients.EmployerAccount.EmployerAccountClientTests
{
    public class WhenGettingEmployersPayeSchemes
    {
        ...
        private List<EmploymentCheck.Data.Models.EmploymentCheck> _apprentices;
        ...
        public void SetUp()
        {
            ...
            _apprentices = new List<EmploymentCheck.Data.Models.EmploymentCheck> { _fixture.Create<EmploymentCheck.Data.Models.EmploymentCheck>() };
        ...
        {
            //Act
            var result = await _sut.GetEmployersPayeSchemes(new List<EmploymentCheck.Data.Models.EmploymentCheck>());
