...
namespace SFA.DAS.EmploymentCheck.Queries.UnitTests.GetEmployerPayeSchemes.GetEmployerPayeSchemesMediatorHandlerTests
{
    public class WhenHandlingTheRequest
    {
        ...
        private readonly List<EmploymentCheck.Data.Models.EmploymentCheck> _apprentices;
        ...
        public WhenHandlingTheRequest()
        {
            ...
            _apprentices = fixture.CreateMany<EmploymentCheck.Data.Models.EmploymentCheck>().ToList();
        }
        ...
        {
            //Arrange
            var request = new GetPayeSchemesQueryRequest(new List<EmploymentCheck.Data.Models.EmploymentCheck>());
            ...
            //Act
            var result = await sut.Handle(new GetPayeSchemesQueryRequest(new List<EmploymentCheck.Data.Models.EmploymentCheck>()),
