...
{
    public class WhenTriggeringHttpResponseOrchestrator
    {
        ...
        public async Task Then_The_Instance_Id_Is_Created_When_no_other_instances_are_running()
        {
            ...
            _starter.Setup(x => x.StartNewAsync(nameof(ResponseOrchestrator), It.IsAny<string>()))
            ...
            // Act
            var result = await ResponseOrchestratorHttpTrigger.HttpStart(_request.Object, _starter.Object, _logger.Object);
